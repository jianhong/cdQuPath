...
VizDimLoadings(seu, dims = dim, reduction = "pca")
...
The Jaccard Index is a statistic used for gauging the similarity and diversity of sample sets. The Jaccard Index is defined as: $\frac{cooccurent_celltype_A_and_B}{count_celltype_A + count_celltype_B - cooccurent_celltype_A_and_B}$
...
The spatial score define the distance ratio among three factors. The spatial score is defined as: $\frac{celltypeCenter_distance_to_nearest_celltypeRight}{celltypeCenter_distance_to_nearest_celltypeLeft}$.
